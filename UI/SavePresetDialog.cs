                    ...
                    Children = new Drawable[]
                    {
                        ...
                        new FillFlowContainer
                        {
                            ...
                            Children = new Drawable[]
                            {
                                new FillFlowContainer
                                {
                                    ...
                                    Children = new Drawable[]
                                    {
                                        ...
                                        new OsuSpriteText
                                        {
                                            Anchor = Anchor.CentreLeft,
                                            Origin = Anchor.CentreLeft,
                                            Text = ExtendedToolbarStrings.DialogSavePresetTitle,
                                ...
                                new OsuSpriteText
                                {
                                    Text = ExtendedToolbarStrings.DialogSavePresetPrompt,
                                ...
                                new FillFlowContainer
                                {
                                    ...
                                    Children = new Drawable[]
                                    {
                                        new RoundedButton
                                        {
                                            Width = 180,
                                            Height = 38,
                                            Text = ExtendedToolbarStrings.DialogSaveButton,
                                        ...
                                        new RoundedButton
                                        {
                                            Width = 180,
                                            Height = 38,
                                            Text = ExtendedToolbarStrings.DialogCancelButton,
